...
public interface JobDescription extends SagaObject, Attributes {
    ...
    /** Attribute name, job description */
    public static final String JOBDESCRIPTION = "JobDescription";
    
    /** Attribute name, job Application name */
    ...
    public static final String QUEUE = "machine.queue";
    ...
    public static final String JOBUID = "JobUID";
    
    public static final String SPMD_POSIX = "SPMD_POSIX";
